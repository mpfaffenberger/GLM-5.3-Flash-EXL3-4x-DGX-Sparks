...
BASE_URL=${GLM53_BASE_URL:-http://127.0.0.1:8888/v1}
MODEL=${GLM53_MODEL:-Mia-AiLab/GLM-5.3-Flash-EXL3-TR3-4bpw}
SERVED_MODEL=${GLM53_SERVED_NAME:-GLM-5.3-Flash-EXL3}
REVISION=${GLM53_REVISION:-25a44fdbf16862a46b7cc9921142c6c81350af2f}
MODEL_CACHE_DIR=${GLM53_MODEL_CACHE_DIR:-models--Mia-AiLab--GLM-5.3-Flash-EXL3-TR3-4bpw}
...
do
  uvx --from llama-benchy==0.4.0 python "$ROOT/overlay/$patch"
done
...
printf '\n' >>"$COMMAND_FILE"
printf '%s\n' "$RESULT_DIR" >"$HOME/llama-benchy-glm53-exl3.current"
